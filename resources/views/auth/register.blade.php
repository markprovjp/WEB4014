<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select id="phai" name="phai" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                <option value="Nam" {{ old('phai') == 'Nam' ? 'selected' : '' }}>Nam</option>
                <option value="Nữ" {{ old('phai') == 'Nữ' ? 'selected' : '' }}>Nữ</option>
                <option value="Khác" {{ old('phai') == 'Khác' ? 'selected' : '' }}>Khác</option>
            </select>
